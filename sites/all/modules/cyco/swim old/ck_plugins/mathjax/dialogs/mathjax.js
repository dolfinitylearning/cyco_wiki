		...
		contents: [
			{
              ...
              //Set the value of the Small (inline) checkbox.
              this.getDialog().getContentElement('info','small').setValue(
                CKEDITOR.plugins.mathjax.isSmall( widget.data.math )
              );
							// Remove \( and \) or \[ and \].
						...
						commit: function( widget ) {
							// Add \( and \) or \[ and \] to make TeX be parsed by 
              // MathJax by default.
              var small = this.getDialog().getContentElement('info','small').getValue();
              if ( small ) {
