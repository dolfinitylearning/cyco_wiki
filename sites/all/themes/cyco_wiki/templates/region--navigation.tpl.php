...
//Slimy hacks to make the nav fluid. Can't figure out the right way to do it.
$content_attributes = str_replace('"container"', '"container-fluid"', $content_attributes);
$attributes = str_replace(' container ', ' container-fluid ', $attributes);
